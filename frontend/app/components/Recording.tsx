...
export default function Recording({
  ...
  return (
    ...
    >
      ...
      >
        {texts.recordingLanguageHint}
      </Typography>
      <Box
        component="button"
        type="button"
        aria-label={`${texts.releaseSpacebarToSendPrefix} Spacebar ${texts.releaseSpacebarToSendSuffix}`}
        onPointerUp={onSpacebarUp}
        onClick={onSpacebarUp}
        sx={{
          border: "none",
      ...
      >
        ...
        >
          {texts.releaseSpacebarToSendPrefix} <span style={{color: "#2362DB"}}>Spacebar</span> {texts.releaseSpacebarToSendSuffix}
        </Typography>
      </Box>
    </Grid2>
  )
