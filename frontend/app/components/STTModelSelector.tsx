...
import { STTModelOption } from "./type";

export default function STTModelSelector({
  language,
  models,
  currentModel,
  disabled,
  ...
  const label = currentOption?.label ?? texts.sttModelUnavailable;
  ...
  return (
    ...
    >
      ...
      >
        {isSwitching ? texts.sttModelSwitching : label}
      </Button>
      <Menu
        anchorEl={anchorEl}
        open={isOpen}
